...
open class ReviewScreenPreference: NSObject {
    ...
    fileprivate static let DEFAULT_AMOUNT_TITLE = PXStrings.unit_price_string.localized_beta
    fileprivate static let DEFAULT_QUANTITY_TITLE = PXStrings.quantity_string.localized_beta
